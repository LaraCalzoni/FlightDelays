...
public class ExtFlightDelaysDAO {
	...
	public List<Airport> loadAllAirports(Map<Integer, Airport> idMap) {
		String sql = "SELECT * FROM airports";List<Airport> result = new ArrayList<Airport>();
	...
	public List <Rotta> getRotte(Map <Integer, Airport> idMap){
		...
		try {
			...
			while (rs.next()) {
				...
				if(sorgente!= null && destinazione!= null) { //faccio questo controllo
															 //perchè db potrebbe avere dati mancanti
